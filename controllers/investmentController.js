...
//   if (plan.name === "Beginner Plan") {
//     interestRate = 10; // 10% interest
//     minMaturity = 3500;
//     maxMaturity = 10000;
//   } else if (plan.name === "Essential Plan") {
...
//     minMaturity = 21000;
//     maxMaturity = 40000;
//   } else if (plan.name === "Premier Plan") {
...
const startInvestment = asyncHandler(async (req, res) => {
  ...
  // ✅ Correct maturity calculation = investment + profit
  const maturityAmount = parseFloat(
    (investmentAmount + (investmentAmount * plan.interestRate) / 100).toFixed(2)
  );

  console.log(
    `Final maturity amount for ${plan.name} at ${plan.interestRate}%: $${maturityAmount}`
  );
