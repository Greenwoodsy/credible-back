...
const sendVerificationEmail = asyncHandler(async (req, res) => {
  ...
  // Send Email
  const subject = "Verify Your Account - CredibleInvestmentExperts";
  const send_to = user.email;
  const sent_from = process.env.EMAIL_USER;
  const reply_to = "noreply@credibleinvestmentexperts.com";
...
const forgotPassword = asyncHandler(async (req, res) => {
  ...
  // Send Email
  const subject = "Password Reset Request - CredibleInvestmentExperts";
  const send_to = user.email;
  const sent_from = process.env.EMAIL_USER;
  const reply_to = "noreply@credibleinvestmentexperts.com";
...
const sendLoginCode = asyncHandler(async (req, res) => {
  ...
  // Send Login Code
  const subject = "Login Access Code - CredibleInvestmentExperts";
  const send_to = email;
  const sent_from = process.env.EMAIL_USER;
  const reply_to = "noreply@credibleinvestmentexperts.com";
